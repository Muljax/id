...
## [2.0.0](https://github.com/Muljax/id/compare/muljax-id-v1.2.0...muljax-id-v2.0.0) (2026-09-21)
...
* **api,dashboard:** add admin sessions endpoints and client methods ([d397924](https://github.com/Muljax/id/commit/d39792490d20ab821199374abfc32c67688677e5))
* **api,dashboard:** complete openapi migration and standardize typed api client ([c3f8cb0](https://github.com/Muljax/id/commit/c3f8cb07c94fb42bd194bd368f6447861f26b951))
* **api:** migrate account route group to @hono/zod-openapi and zod validation ([974e015](https://github.com/Muljax/id/commit/974e015e6e6de8136105e85745ac21d081aa85b2))
* **api:** migrate admin and users route groups to @hono/zod-openapi and zod validation ([efc5632](https://github.com/Muljax/id/commit/efc5632d442aedde3d5020196bbe048501e7a6f0))
* **api:** migrate auth route group to @hono/zod-openapi and zod validation ([b047790](https://github.com/Muljax/id/commit/b04779049db9f099e346acee6a1c4b625a228c68))
* **api:** migrate notifications route group to @hono/zod-openapi and zod validation ([e2d35f0](https://github.com/Muljax/id/commit/e2d35f09adc93b727d2df34bf317339921506d07))
* **api:** migrate oauth and well-known route groups to @hono/zod-openapi and mount openapi spec ([a1b2434](https://github.com/Muljax/id/commit/a1b2434322fdf83ec6a48b7f5e3b49ab4067a05e))
* **api:** migrate passkeys route group to @hono/zod-openapi and zod validation ([10a58bb](https://github.com/Muljax/id/commit/10a58bb1a927971bce7591366191c6310629790d))
* **api:** migrate ssh route group to @hono/zod-openapi and zod validation ([de10719](https://github.com/Muljax/id/commit/de107193aeee234549cb60c07d9bdd8891462e46))
...
* **auth:** add step-up authentication and session elevation ([d01728f](https://github.com/Muljax/id/commit/d01728ffac25c43c2da0ff80e1af42bb565389c2))
...
* **dashboard:** add custom ssh principal management in role modal ([806d208](https://github.com/Muljax/id/commit/806d208369f77ebda00c234dc49642a0d4189418))
...
* **dashboard:** autofocus first editable field in modals ([a40ff20](https://github.com/Muljax/id/commit/a40ff20dd865b9b4c6de184f2e10a0d76a994575))
...
* **dashboard:** submit modals on enter key ([c1d3a57](https://github.com/Muljax/id/commit/c1d3a57fa3a6bbcaa6916662a99dff9bb5a3f74a))
...
* **infra:** add Cloudflare Worker deployment and terraform config for docs portal ([b10fa50](https://github.com/Muljax/id/commit/b10fa503dc2952a79f30c25d8fc9a5abdc245acf))
...
* **lifecycle:** add account deletion across api and dashboard ([a859249](https://github.com/Muljax/id/commit/a859249d77790a35bd82d2f1c660760521b27d2e))
...
* **oauth:** update submodules with rfc 8628 device authorization grant ([10ca607](https://github.com/Muljax/id/commit/10ca6070f7b361ca6528cb370a5566dd2534a045))
...
* **passkeys:** implement conditional autofill and clean passkey management ([1b645ef](https://github.com/Muljax/id/commit/1b645efc00871b07d0d3f85ed83cdac690418e7d))
...
* **ssh:** support custom principal claims and rbac delegation ([f3e40d5](https://github.com/Muljax/id/commit/f3e40d53ea9f6ca7fad454e0be04d134974eb2cd))
...
* update api, dashboard, and docs submodules with sessions map and admin endpoints ([7163697](https://github.com/Muljax/id/commit/716369713c9b67ff607598efe8642e4fd8beb956))
...
* **api:** clean up auth password reset route paths in openapi ([c85e38f](https://github.com/Muljax/id/commit/c85e38fd830a2494198eee0f894742d059ef0609))
...
* **deps:** update dependency @shikijs/rehype to v4 ([#251](https://github.com/Muljax/id/issues/251)) ([5b72cff](https://github.com/Muljax/id/commit/5b72cff5b2c5f0b4afb8f3efca4b4605484a4733))
...
* **notifications:** resolve SSE streaming cross-isolate delivery and toast bursts ([b75d5f0](https://github.com/Muljax/id/commit/b75d5f0b21255bc4d9fccf2dcb5274e5ac3b8969))
