/**
 * Security and input validation for OpenSSH Certificate Authority operations.
 *
 * Implements strict sanity checks on public keys, principals, key IDs,
 * validity periods, extensions, and critical options according to the
 * OpenSSH `PROTOCOL.certkeys` specification and POSIX username constraints.
 */

/**
 * Custom error thrown when input validation fails for an SSH CA operation.
 */
