...
export const getAdminRoleByIdRoute = createRoute({
	method: "get",
	path: "/",
	tags: ["Admin Roles"],
	summary: "Get role by ID",
	description:
		"Retrieves a specific role definition and its assigned permissions.",
...
route.openapi(getAdminRoleByIdRoute, async (c) => {
