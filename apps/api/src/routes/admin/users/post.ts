...
export const createAdminUserRoute = createRoute({
	method: "post",
	path: "/",
	tags: ["Admin Users"],
	summary: "Create a user account",
	description:
		"Creates a new user account directly with an optional password and initial role.",
	...
	responses: {
		...
		400: {
			...
			description: "Bad request - Invalid user payload or role not found",
		},
		401: {
			content: {
				"application/json": {
...
route.openapi(createAdminUserRoute, async (c) => {
