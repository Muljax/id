...
`ID` includes a built-in OpenID Connect (OIDC) and OAuth 2.0 authorization server. Administrators manage client applications via **Admin** -> **Clients** (`/admin/clients`).
