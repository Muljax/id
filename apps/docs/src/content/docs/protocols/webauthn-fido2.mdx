...
- **[W3C Web Authentication (WebAuthn Level 3)](https://www.w3.org/TR/webauthn-3/)**: Browser JavaScript APIs (`navigator.credentials.create` and `navigator.credentials.get`) and server validation rules.
- **[FIDO Alliance CTAP 2.1](https://fidoalliance.org/specs/fido-v2.1-ps-20210615/fido-client-to-authenticator-protocol-v2.1-ps-20210615.html)**: Client to Authenticator Protocol for communicating with USB, NFC, and Bluetooth authenticators.
...
| Threat | Attack Vector | Mitigation in `ID` |
| :--- | :--- | :--- |
