...
<Callout type="caution" title="Ed25519 Requirement">
Legacy RSA, DSA, and ECDSA keys are rejected during upload with <code>400 Bad Request</code>. Generate an Ed25519 keypair using the instructions below.
</Callout>
